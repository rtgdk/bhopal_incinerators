...
class Waste(models.Model):
	...
	name = models.CharField(max_length=64)
	waste1 = models.IntegerField(blank=True,null=True,default=0)
	waste2 = models.IntegerField(blank=True,null=True,default=0)
	waste3 = models.IntegerField(blank=True,null=True,default=0)
	def __str__(self):
